...
@section('content')
    <section class="pager-section">
        <div class="container">
            <div class="pager-content text-center"><h2>Events</h2>
                <ul>
                    <li><a href="{{route('home')}}" title="">Home</a></li>
                    <li><span>Events</span></li>
                </ul>
            </div><!--pager-content end--><h2 class="page-titlee">Shelly</h2></div>
        ...
        <div class="container">
                        ...
                        <div class="col-lg-6">
                            <div class="course-card">
                                ...
                                <div class="d-flex flex-wrap">
                                    <div class="posted-by"><img src="assets/img/ico2.png" alt=""> <a href="events.html#"
                                                                                                     title="">Amanda
                                            Kern</a></div>
            ...
            <div class="mdp-pagiation">
                <nav aria-label="Page navigation example">
                    <ul class="pagination">
                        <li class="page-item"><a class="page-link" href="events.html#">1</a></li>
                        <li class="page-item"><a class="page-link active" href="events.html#">2</a></li>
                        <li class="page-item"><a class="page-link" href="events.html#">3</a></li>
                        <li class="page-item"><a class="page-link" href="events.html#">4</a></li>
                        <li class="page-item"><a class="page-link" href="events.html#">...</a></li>
                        <li class="page-item"><a class="page-link" href="events.html#">15</a></li>
                    </ul>
                </nav>
        ...
        <div class="container">
            <div class="newsletter-sec">
                <div class="row align-items-center">
                    <div class="col-lg-4">
                        <div class="newsz-ltr-text"><h2>Join us<br>and stay tuned!</h2><a href="contacts.html" title=""
                                                                                          class="btn-default">Join Us <i
                                    class="fa fa-long-arrow-alt-right"></i></a></div><!--newsz-ltr-text end--></div>
                    <div class="col-lg-8">
