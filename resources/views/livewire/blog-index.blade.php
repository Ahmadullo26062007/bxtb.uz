                        ...
                        <div class="blog-info">
                            <ul class="meta">
                                ...
                                <li><img src="assets/img/icon13.png" alt="">
                                    <a href="" title="">{{$blog->category->name}},</a><a title=""> School</a>
                                </li>
                            </ul>
                            <h3 class="stick"><a href="{{route('blog.show',$blog->id)}}" title="">{{$blog->title}}</a>
                            </h3>
                            <p>{{$blog->description}}</p>
                            <a href="{{route('blog.show',$blog->id)}}" title="" class="read-more">Ko`rish <i
                ...
                <nav aria-label="Page navigation example">
                    <ul class="pagination">
                        @if((count( \App\Models\Blog::where('school_id',env('SCHOOL_ID'))->get()->ToArray() )>$count))
                            <li class="page-item"><a style="color:#f37335 " class="page-link"
                                                     wire:click="pilus()">Yana+</a></li>
                        @endif
                    </ul>
                </nav>
            </div>
        ...
        <div class="sidebar">
            ...
            <div class="widget widget-calendar">
                ...
                <div class="mdp-calendar">
                    ...
                    {{--                    </table>--}}
                    {{--                    <ul class="controls">--}}
                    {{--                        <li><a  title=""><i class="fa fa-angle-left"></i> Prev</a>--}}
                    {{--                        </li>--}}
                    {{--                        <li><a  title="">Next <i class="fa fa-angle-right"></i></a>--}}
                    {{--                        </li>--}}
                    {{--                    </ul>--}}
                </div>
                <!--mdp-calendar end-->
